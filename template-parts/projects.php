...
<section class="content-wrapper portfolio" data-title="<?php _e( 'Projects', 'welcome' ); ?>">
	<div class="content-header">
		<h2 class="content-title"><?php _e( 'Projects', 'welcome' ); ?></h2>
					...
					<div class="work-content">
						...
						<div class="work-meta">
							...
							<?php if ( ! empty( $project['source_code_link'] ) ) : ?>
								<a href="<?php echo esc_url( $project['source_code_link'] ); ?>" title="Source Code">
